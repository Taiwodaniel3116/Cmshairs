...
{/*  */}
    ...
    <p className='text-center mt-2'>Discover our premium collection of hair extensions and wigs.</p>

    <div className=' flex justify-center mt-3'>
    <input type="text" placeholder='Search products...' className='bg-gray-200 px-10 py-2 rounded-full outline-green-400 caret-green-400'/>
    </div>
